...
DistanceApproachIPOPTInterface::DistanceApproachIPOPTInterface(
    ...
    : ts_(ts), ego_(ego), xWS_(xWS), uWS_(uWS), l_warm_up_(l_warm_up),
      n_warm_up_(n_warm_up), x0_(x0), xf_(xf), last_time_u_(last_time_u),
      XYbounds_(XYbounds), obstacles_edges_num_(obstacles_edges_num),
...
bool DistanceApproachIPOPTInterface::get_nlp_info(int &n, int &m,
  ...
  // number of variables
  n = num_of_variables_;
  std::cout << "num_of_variables_ " << num_of_variables_;
  // number of constraints
  m = num_of_constraints_;
  std::cout << "num_of_constraints_ " << num_of_constraints_;
...
bool DistanceApproachIPOPTInterface::get_bounds_info(int n, double *x_l,
  ...
  std::cout << "variable_index after adding control variables : "
            << variable_index;
  ...
  std::cout << "variable_index after adding sample time : " << variable_index;
  std::cout << "sample time fix time status is : " << use_fix_time_;
  ...
  std::cout << "variable_index after adding lagrange l : " << variable_index;
  ...
  std::cout << "variable_index after adding lagrange n : " << variable_index;
  ...
  std::cout << "constraint_index after adding time constraints: "
            << constraint_index;
  ...
  std::cout << "constraint_index after adding obstacles constraints: "
            << constraint_index;
  std::cout << "get_bounds_info_ out";
  return true;
}
...
void DistanceApproachIPOPTInterface::finalize_solution(
  ...
  if (enable_constraint_check_) {
    std::cout << "final resolution constraint checking";
    check_g(n, x, m, g);
  }
  // 1. state variables, 4 * [0, horizon]
  // 2. control variables, 2 * [0, horizon_-1]
...
void DistanceApproachIPOPTInterface::get_optimization_results(
  ...
  *dual_n_result = dual_n_result_;
  ...
  std::cout << "dual_l_diff_max: " << l_diff_max;
  std::cout << "dual_n_diff_max: " << n_diff_max;
}
...
void DistanceApproachIPOPTInterface::eval_constraints(int n, const T *x, int m,
  ...
  std::cout << "constraint_index after obstacles avoidance constraints "
               "updated: "
            << constraint_index;
